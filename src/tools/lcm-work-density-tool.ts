...
const LcmWorkDensitySchema = Type.Object({
  ...
  topic: Type.Optional(Type.String({ description: "Bounded deterministic topic filter over topic keys, titles, and rationales. Uses escaped literal matching, not fuzzy search." })),
